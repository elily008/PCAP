...
if __name__ == '__main__':
    ...
    df250 = pd.read_csv(os.path.join(base_path, "3-128-2-3-250.dr"), names=['Output Bytes Rate', 'Input Bytes Rate', 'Output Packet Rate', 'Input Packet Rate', 'Delivery Rate Mean', 'Drop Rate Std'])
    df500 = pd.read_csv(os.path.join(base_path, "3-128-2-3-500.dr"), names=['Output Bytes Rate', 'Input Bytes Rate', 'Output Packet Rate', 'Input Packet Rate', 'Delivery Rate Mean', 'Drop Rate Std'])
    df750 = pd.read_csv(os.path.join(base_path, "3-128-2-3-750.dr"), names=['Output Bytes Rate', 'Input Bytes Rate', 'Output Packet Rate', 'Input Packet Rate', 'Delivery Rate Mean', 'Drop Rate Std'])
    df1000 = pd.read_csv(os.path.join(base_path, "3-128-2-3-1000.dr"), names=['Output Bytes Rate', 'Input Bytes Rate', 'Output Packet Rate', 'Input Packet Rate', 'Delivery Rate Mean', 'Drop Rate Std'])
    ...
    ax1.set_title('Packet Size 128 Bits')
    ax1.grid(True)
